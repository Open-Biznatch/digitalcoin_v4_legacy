...
if [ -d "$OUT_DIR" -a -w "$OUT_DIR" ]; then
  set +e
  # Windows:
  cp /Users/alx/Documents/Projets/digitalcoin/win32-build/src/bitcoind.exe $OUT_DIR/bitcoind.exe
  cp /Users/alx/Documents/Projets/digitalcoin/win32-build/src/test/test_bitcoin.exe $OUT_DIR/test_bitcoin.exe
  cp /Users/alx/Documents/Projets/digitalcoin/win32-build/src/qt/bitcoind-qt.exe $OUT_DIR/bitcoin-qt.exe
  # Linux:
  cp /Users/alx/Documents/Projets/digitalcoin/linux-build/src/bitcoind $OUT_DIR/bitcoind
  cp /Users/alx/Documents/Projets/digitalcoin/linux-build/src/test/test_bitcoin $OUT_DIR/test_bitcoin
  cp /Users/alx/Documents/Projets/digitalcoin/linux-build/src/qt/bitcoind-qt $OUT_DIR/bitcoin-qt
  set -e
fi

# Run unit tests and blockchain-tester on Linux:
cd /Users/alx/Documents/Projets/digitalcoin/linux-build
make check

# Run RPC integration test on Linux:
/Users/alx/Documents/Projets/digitalcoin/qa/rpc-tests/wallet.sh /Users/alx/Documents/Projets/digitalcoin/linux-build/src
/Users/alx/Documents/Projets/digitalcoin/qa/rpc-tests/listtransactions.py --srcdir /Users/alx/Documents/Projets/digitalcoin/linux-build/src
# Clean up cache/ directory that the python regression tests create
rm -rf cache

if [ $RUN_EXPENSIVE_TESTS = 1 ]; then
  # Run unit tests and blockchain-tester on Windows:
  cd /Users/alx/Documents/Projets/digitalcoin/win32-build
  make check
fi
