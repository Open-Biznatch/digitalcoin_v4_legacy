                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
	...
	configLine += "\naddnode=62.82.191.195";
	configLine += "\naddnode=66.207.140.12";
	configLine += "\naddnode=69.30.199.114";
	configLine += "\naddnode=71.68.33.84";
	configLine += "\naddnode=77.249.213.25";
	configLine += "\naddnode=86.123.35.139";
	configLine += "\naddnode=86.123.57.61";
	configLine += "\naddnode=86.193.159.109";
	configLine += "\naddnode=91.8.198.64";
	configLine += "\naddnode=91.8.201.165";
	configLine += "\naddnode=91.8.231.177";
